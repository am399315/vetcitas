...
export default function App() {
  const { citas, loading, error, addCita, deleteCita, refetch } = useAppointments()
    ...
    <div className="app">
        ...
        <div className="header-inner">
          ...
          <nav className="header-stats" aria-label="Estadísticas">
            <div className="stat-pill">
              <span className="stat-pill-num">{loading ? '…' : citas.length}</span>
              <span className="stat-pill-label">Total</span>
            </div>
            <div className="stat-pill stat-pill-accent">
              <span className="stat-pill-num">{loading ? '…' : proximas}</span>
      ...
      <main className="app-main">
        ...
        <div className="layout">
          ...
          <AppointmentList citas={citas} loading={loading} onDelete={deleteCita} />
        </div>
      </main>

      <footer className="app-footer">
        <p>VetCitas &copy; {new Date().getFullYear()} &mdash; Hecho con React &amp; Supabase</p>
      </footer>
    </div>
  )
}
